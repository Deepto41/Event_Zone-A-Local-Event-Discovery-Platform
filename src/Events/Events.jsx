...
const Events = ({ data }) => {
  ...
  <figure>
    <img className="w-[80%] h-40 p-4 border-1 rounded-md mt-2 bg-white"
      src={thumbnail}
      alt="" />
  </figure>
  <div className="card-body justify-center items-center">
    ...
    <p className="font-semibold"><small>Date:{date}</small></p>
  
      <p className="text-md font-semibold">Location:{location}</p>
      <p className="text-md font-semibold">Entry Fee:{entry_fee}</p>
      <button className="btn bg-[#0EA106] rounded-md w-full">View More</button>
  </div>
